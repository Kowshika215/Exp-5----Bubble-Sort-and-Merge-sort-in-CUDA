...
<img width="1919" height="337" alt="image" src="https://github.com/user-attachments/assets/e7446a09-72ae-425e-9550-12e4f5219282" />


## RESULT:
Thus, the program has been executed using CUDA to implement and compare Bubble Sort and Merge Sort algorithms on both CPU and GPU, and the execution time for each sorting technique has been successfully measured and analyzed.
